...
function start3d() {
  ...
  var sphere = quickJsProject.ShapeUtils.makeSphere(1, 3, 4);
  renderer.fill_rgba = new quickJsProject.RGBA(0x78 / 255, 0xff / 255, 0, 1);

  // Do an extrusion so we can some interesting non-planar quads.
  var extruder = new quickJsProject.ShapeUtils.Extruder();
  ...
  // Paint normal lines.
  renderer.normal1_rgba = new quickJsProject.RGBA(1, 0, 0, 1);
  renderer.normal2_rgba = new quickJsProject.RGBA(0, 1, 0, 1);
