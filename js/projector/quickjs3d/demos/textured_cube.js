...
function start3d(texture_image) {
  ...
  var cube = quickJsProject.ShapeUtils.makeCube(1);
  ...
  quickJsProject.ShapeUtils.triangulate(cube);

  var w = texture_image.width;
  var h = texture_image.height;

  var texinfo1 = new quickJsProject.TextureInfo();
  ...
  var texinfo2 = new quickJsProject.TextureInfo();
