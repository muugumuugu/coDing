...
function start3d() {
  ...
  var box1 = quickJsProject.ShapeUtils.makeBoxWithHole(1, 1, 1, 0.4, 0.4);
  var box2 = quickJsProject.ShapeUtils.makeCube(1);

  var orange = new quickJsProject.RGBA(0xff / 255, 0x78 / 255, 0, 1);
  var green = new quickJsProject.RGBA(0x78 / 255, 0xff / 255, 0, 1);

  for (var i = 0; i < 3; ++i) {
    quickJsProject.ShapeUtils.linearSubdivide(box1);
    quickJsProject.ShapeUtils.averageSmooth(box1);
  }
