...
function start3d() {
  ...
  var circle_path = quickJsProject.PathUtils.makeCircle();

  var circle_data = [
    {r: 75, x: 0, y: 58,
        c: new quickJsProject.RGBA(27 / 255, 98 / 255, 183 / 255, 1), },
    {r: 46, x: 126, y: 0,
        c: new quickJsProject.RGBA(237 / 255, 28 / 255, 36 / 255, 1), },
    {r: 46, x: 100, y: 0,
        c: new quickJsProject.RGBA(254 / 255, 221 / 255, 3 / 255, 1), },
    {r: 46, x: 100, y: 0,
        c: new quickJsProject.RGBA(27 / 255, 98 / 255, 183 / 255, 1), },
    {r: 46, x: 0, y: -98,
        c: new quickJsProject.RGBA(27 / 255, 98 / 255, 183 / 255, 1), },
    {r: 46, x: 100, y: 0,
        c: new quickJsProject.RGBA(0, 166 / 255, 80 / 255, 1), },
    {r: 46, x: 0, y: 98,
        c: new quickJsProject.RGBA(0, 166 / 255, 80 / 255, 1), },
    {r: 46, x: 100, y: 0,
        c: new quickJsProject.RGBA(237 / 255, 28 / 255, 36 / 255, 1), },
