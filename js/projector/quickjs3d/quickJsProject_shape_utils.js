...
quickJsProject.ShapeUtils = (function() {
  ...
  var subPoints2d = quickJsProject.Math.subPoints2d;
  var subPoints3d = quickJsProject.Math.subPoints3d;
  var addPoints2d = quickJsProject.Math.addPoints2d;
  var addPoints3d = quickJsProject.Math.addPoints3d;
  var mulPoint2d = quickJsProject.Math.mulPoint2d;
  var mulPoint3d = quickJsProject.Math.mulPoint3d;
  var vecMag2d = quickJsProject.Math.vecMag2d;
  var vecMag3d = quickJsProject.Math.vecMag3d;
  var unitVector2d = quickJsProject.Math.unitVector2d;
  var unitVector3d = quickJsProject.Math.unitVector3d;
  var linearInterpolate = quickJsProject.Math.linearInterpolate;
  var linearInterpolatePoints3d = quickJsProject.Math.linearInterpolatePoints3d;
  var averagePoints = quickJsProject.Math.averagePoints;
  ...
  function makePlane(p1, p2, p3, p4) {
    var s = new quickJsProject.Shape();
    s.vertices = [p1, p2, p3, p4];
    s.quads = [new quickJsProject.QuadFace(0, 1, 2, 3)];
    rebuildMeta(s);
    return s;
  }
  ...
  function makeBox(w, h, d) {
    ...
    s.quads = [
      new quickJsProject.QuadFace(0, 1, 2, 3),  // Right side
      new quickJsProject.QuadFace(1, 5, 6, 2),  // Front side
      new quickJsProject.QuadFace(5, 4, 7, 6),  // Left side
      new quickJsProject.QuadFace(4, 0, 3, 7),  // Back side
      new quickJsProject.QuadFace(0, 4, 5, 1),  // Top side
      new quickJsProject.QuadFace(2, 6, 7, 3)   // Bottom side
    ];
  ...
  function makeBoxWithHole(w, h, d, hw, hh) {
    ...
    s.quads = [
      // Front side
      new quickJsProject.QuadFace( 1,  8, 10,  9),
      new quickJsProject.QuadFace( 8, 14, 16, 10),
      new quickJsProject.QuadFace(14,  5, 15, 16),
      new quickJsProject.QuadFace(16, 15, 18, 19),
      new quickJsProject.QuadFace(19, 18,  6, 17),
      new quickJsProject.QuadFace(13, 19, 17, 11),
      new quickJsProject.QuadFace(12, 13, 11,  2),
      new quickJsProject.QuadFace( 9, 10, 13, 12),
      // Back side
      new quickJsProject.QuadFace( 4, 26, 28, 27),
      new quickJsProject.QuadFace(26, 20, 22, 28),
      new quickJsProject.QuadFace(20,  0, 21, 22),
      new quickJsProject.QuadFace(22, 21, 24, 25),
      new quickJsProject.QuadFace(25, 24,  3, 23),
      new quickJsProject.QuadFace(31, 25, 23, 29),
      new quickJsProject.QuadFace(30, 31, 29,  7),
      new quickJsProject.QuadFace(27, 28, 31, 30),
      // The hole
      new quickJsProject.QuadFace(10, 16, 28, 22),
      new quickJsProject.QuadFace(19, 31, 28, 16),
      new quickJsProject.QuadFace(13, 25, 31, 19),
      new quickJsProject.QuadFace(10, 22, 25, 13),
      // Bottom side
      new quickJsProject.QuadFace( 6,  7, 29, 17),
      new quickJsProject.QuadFace(17, 29, 23, 11),
      new quickJsProject.QuadFace(11, 23,  3,  2),
      // Right side
      new quickJsProject.QuadFace( 1,  9, 21,  0),
      new quickJsProject.QuadFace( 9, 12, 24, 21),
      new quickJsProject.QuadFace(12,  2,  3, 24),
      // Left side
      new quickJsProject.QuadFace( 5,  4, 27, 15),
      new quickJsProject.QuadFace(15, 27, 30, 18),
      new quickJsProject.QuadFace(18, 30,  7,  6),
      // Top side
      new quickJsProject.QuadFace(14, 26,  4,  5),
      new quickJsProject.QuadFace( 8, 20, 26, 14),
      new quickJsProject.QuadFace( 1,  0, 20,  8)
    ];
  ...
  function makeSphericalShape(f, tess_x, tess_y) {
    ...
    for (var i = 0; i < tess_y-1; ++i) {
      ...
      for (var j = 0; j < tess_x; ++j) {
        var n = (j + 1) % tess_x;
        quads.push(new quickJsProject.QuadFace(
          stride + j,
          stride + tess_x + j,
          stride + tess_x + n,
          stride + n
  ...
  function makeOctahedron() {
    ...
    for (var i = 0; i < 4; ++i) {
      var i2 = (i + 1) & 3;
      quads[i*2] = new quickJsProject.QuadFace(4, i, i2, null);
      quads[i*2+1] = new quickJsProject.QuadFace(i, 5, i2, null);
    }

    s.quads = quads;
    quickJsProject.ShapeUtils.rebuildMeta(s);
    return s;
  }
  ...
  function linearSubdivide(shape) {
    ...
    for (var i = 0; i < num_quads; ++i) {
      ...
      // New quads ...
      var q0 = new quickJsProject.QuadFace(   i0, ni[0], ni[4], ni[3]);
      var q1 = new quickJsProject.QuadFace(ni[0],    i1, ni[1], ni[4]);
      var q2 = new quickJsProject.QuadFace(ni[4], ni[1],    i2, ni[2]);
      var q3 = new quickJsProject.QuadFace(ni[3], ni[4], ni[2],    i3);
  ...
  function linearSubdivideTri(shape) {
    ...
    for (var i = 0; i < num_tris; ++i) {
      ...
      // New triangles ...
      var q0 = new quickJsProject.QuadFace(   i0, ni[0], ni[2], null);
      var q1 = new quickJsProject.QuadFace(ni[0],    i1, ni[1], null);
      var q2 = new quickJsProject.QuadFace(ni[2], ni[1],    i2, null);
      var q3 = new quickJsProject.QuadFace(ni[0], ni[1], ni[2], null);
  ...
  Extruder.prototype.extrude = function extrude(shape) {
    ...
    for (var i = 0, il = faces.length; i < il; ++i) {
      ...
      for (var z = 0; z < count; ++z) {
        ...
        var t = new quickJsProject.Transform();
        t.rotateX(rx * m);
        t.rotateY(ry * m);
        t.rotateZ(rz * m);
