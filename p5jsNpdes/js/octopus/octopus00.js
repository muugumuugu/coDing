...
function draw() {
  ...
  translate(2*len, 0);
  rotate(-PI / 4);
  arm(len, c, color(248, 38, 37), 1);
  pop();

  push();
  translate(-2*len, 0);
  rotate(PI / 4);
  arm(len, c + 234, color(248, 38, 37), -1);
  pop();

  push();
  translate(3*len/2, len/2);
  rotate(-PI / 8);
  arm(len, c + 150, color(108, 48, 207), 1);
  pop();

  push();
  translate(-3*len/2, len/2);
  rotate(PI / 8);
  arm(len, c + 10, color(108, 48, 207), -1);
  pop();

  push();
  translate(len, 3*len/4);
  arm(len, c + 1000, color(250,248,47), 1);
  pop();

  push();
  translate(-len, 3*len/4);
  //rotate(PI);
  arm(len, c + 1800, color(250,248,47), -1);
  pop();

  fill(08, 248, 127);
  ellipse(0,0-len,  5* len, 4* len); //head
  ...
  translate(len, len);
  rotate(PI / 4);
  arm(len, c + 290, color(08, 248, 127), 1);
  pop();

  push();
  translate(-len, len);
  rotate(-PI / 4);
  arm(len, c + 2960, color(08, 248, 127), -1);
  pop();
