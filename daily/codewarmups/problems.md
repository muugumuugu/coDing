...
A list of practical projects that anyone can solve in any programming language (See [solutions](?entry=./solutions.md). These projects are divided in multiple categories, and each category has its own folder.
