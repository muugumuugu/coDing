...
Begin VB.Form Form1 
   Caption         =   "Calender Generator - Muku"
   ClientHeight    =   4425
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6060
...
cdl.ShowColor
If Button = 1 Then Label1(Index).BackColor = cdl.Color 'lft
If Button = 2 Then Label1(Index).ForeColor = cdl.Color 'rt
